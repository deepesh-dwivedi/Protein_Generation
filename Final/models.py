...
class Args:
    def __init__(self, num_features, nhid, num_classes, pooling_ratio, dropout_ratio, sample_neighbor=False, sparse_attention=False, structure_learning=False, lamb=False):
